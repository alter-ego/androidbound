...
public class Observable<T> implements IObservable<T> {
    ...
    public IDisposable subscribe(Object instance, String nextMethod, String errorMethod, String completeMethod) {
        return subscribe(Actions.<T>fromMethod(instance, nextMethod), Actions.<Exception>fromMethod(instance, errorMethod),
                Actions.fromVoidMethod(instance, completeMethod));
    }
            ...
            public IDisposable invoke(final IObserver<T> observer) {
                return subscribe(new IObserver<T>() {
                    ...
                    private void schedule() {
                        ...
                        this.futureSchedule = ThreadPoolScheduler.instance.schedule(new Runnable() {
                            @Override
                            public void run() {
                                onNextInSchedule();
                            }
