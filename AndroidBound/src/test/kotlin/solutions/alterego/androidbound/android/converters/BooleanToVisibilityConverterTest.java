...
public class BooleanToVisibilityConverterTest {
    ...
    public BooleanToVisibilityConverterTest() {
        mTestConverter = new BooleanToVisibilityConverter();
    }

    @Test
    public void converterHasAName() {
        Assertions.assertThat(mTestConverter.getBindingName()).isNotNull();
        Assertions.assertThat(mTestConverter.getBindingName()).isEqualTo(BooleanToVisibilityConverter.CONVERTER_NAME);
    }

    @Test
    public void converterDoesntUseTargetClass() {
        Assertions.assertThat(mTestConverter.convert(false, null, null, null)).isEqualTo(View.GONE);
        Assertions.assertThat(mTestConverter.convert(false, Boolean.class, null, null)).isEqualTo(View.GONE);
        Assertions.assertThat(mTestConverter.convert(false, String.class, null, null)).isEqualTo(View.GONE);
        Assertions.assertThat(mTestConverter.convert(false, Integer.class, null, null)).isEqualTo(View.GONE);
        Assertions.assertThat(mTestConverter.convert(false, Long.class, null, null)).isEqualTo(View.GONE);
        Assertions.assertThat(mTestConverter.convert(false, Double.class, null, null)).isEqualTo(View.GONE);
    }
    ...
    public void converterDoesntUseLocale() {
        Assertions.assertThat(mTestConverter.convert(false, null, null, null)).isEqualTo(View.GONE);
        Assertions.assertThat(mTestConverter.convert(false, null, null, Locale.UK)).isEqualTo(View.GONE);
        Assertions.assertThat(mTestConverter.convert(false, null, null, Locale.US)).isEqualTo(View.GONE);
        Assertions.assertThat(mTestConverter.convert(false, null, null, Locale.CHINA)).isEqualTo(View.GONE);
        Assertions.assertThat(mTestConverter.convert(false, null, null, Locale.forLanguageTag("ar-001"))).isEqualTo(View.GONE);
    }

    @Test
    public void converterInterpretsNullValuesAsFalse() {
        Assertions.assertThat(mTestConverter.convert(null, null, null, null)).isEqualTo(View.GONE);
    }
    ...
    public void parameterInvertInverts() {
        Assertions.assertThat(mTestConverter.convert(true, null, "invert", null)).isEqualTo(View.GONE);
